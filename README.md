...
A modern crypto vault application built with Next.js, designed to provide secure and user-friendly cryptocurrency management.

## Features

- **Secure Storage**: Safely store and manage your cryptocurrencies.
- **Real-time Tracking**: Monitor your portfolio with live updates.
